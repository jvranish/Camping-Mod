...
public class Blocks {
	...
	public static final String BLOCK_CAMP_MULTI_GAME_NAME = Colors.COLOR_AQUA_LIGHT + "Multi Cooking Campfire";
	public static final String BLOCK_CAMP_FAST_GAME_NAME = Colors.COLOR_AQUA_LIGHT + "Fast Cooking Campfire";
