...
public class ModRecipies {
	...
	public static void init() 
	{
		...
		{
			GameRegistry.addShapelessRecipe(ItemStacks.campfireInsta, ItemStacks.campfireFast, ItemStacks.campfireMulti, ItemStacks.campfire, ItemStacks.campfireCheap);
		}
		...
		GameRegistry.addRecipe(ItemStacks.campfireFast, " x ", "xyx", " x ", 'x', ItemStacks.flintst, 'y', ItemStacks.campfire);
		GameRegistry.addRecipe(ItemStacks.campfireCheap, " x ", "xyx", " x ", 'x', ItemStacks.enderp, 'y', ItemStacks.campfire);
